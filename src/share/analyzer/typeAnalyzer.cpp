...
namespace evoBasic{
    ...
    void try_implicit_conversion(Location *location, ast::Expression **expr, type::Prototype *target, CompileTimeContext *context){
    ...
    void passValToVal(Location *location, ast::Argument *ast_node, CompileTimeContext *context){
    ...
    void passValToRef(Location *location, ast::Argument *ast_node,
                      type::Function *function, CompileTimeContext *context){
        auto arg_prototype = ast_node->expr->type->getPrototype();
        auto param_prototype = ast_node->parameter->getPrototype();
    ...
    void parameterPassingResolution(Location *location, parseTree::Argument::PassKind pass_kind, ast::Argument *ast_node,
                                    type::Function *current_function, CompileTimeContext *context){
